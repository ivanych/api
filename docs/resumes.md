...
```json
{
    ...
    "download": {
        "pdf": {
            "url": "https://hh.ru/api_resume_converter/ФамилияИмяОтчество.pdf?type=pdf&id=12345678901234567890123456789012abcdef"
        },
        "rtf": {
            "url": "https://hh.ru/api_resume_converter/ФамилияИмяОтчество.rtf?type=pdf&id=12345678901234567890123456789012abcdef"
        }
    }
}
```
...
Соискатель может скачать свои резюме, работодатель - резюме соискателей (без купленного доступа к базе резюме в файлах буду отсутствовать контакты). Название скачиваемого файла будет содержать имя соискателя или его желаемую должность.
